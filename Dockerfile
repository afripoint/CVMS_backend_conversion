...
# Copy .env file before running Django commands
COPY .env /app/.env

# Ensure Django settings can read the .env file
RUN python -c "import os; from dotenv import load_dotenv; load_dotenv(); assert os.getenv('DJANGO_SECRET_KEY'), 'DJANGO_SECRET_KEY is missing!'"
